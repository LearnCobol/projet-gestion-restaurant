     *******RECHERCHER NUM RESA**************************************
       ...
       PERFORM WITH TEST AFTER UNTIL Wfin = 1
         ...
         END-READ
       END-PERFORM.
      *AJOUTER LA LIGNE SUIVANTE POUR CORRIGER PB DE L'AJOUT :   
       CLOSE freservations.
     ***********RECHERCHER CLIENT************************************
       RECHERCHER_CLIENT.
       OPEN INPUT fclients
...
*********************SAISIR_COMMANDE********************************
       ...
       READ freservations
        INVALID KEY
          DISPLAY 'Erreur lors de la saisie de l identifiant'
        NOT INVALID KEY
